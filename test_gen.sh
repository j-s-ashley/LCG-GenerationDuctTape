...
echo LCG sourced. Creating $proc_card_name with
...
total_runs=$(( total_dirs * num_runs ))
echo with 3 runs each for a total of $total_dirs directories and $total_runs runs.
